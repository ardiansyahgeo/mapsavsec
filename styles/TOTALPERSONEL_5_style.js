...
var style_TOTALPERSONEL_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("T_PERSONIL");
    var labelText = "";
    size = 0;
    ...
    if (value >= 1.000000 && value <= 42.200000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 42.200000 && value <= 65.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 65.600000 && value <= 89.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 89.200000 && value <= 152.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 152.600000 && value <= 1809.000000) {
            style = [ new ol.style.Style({
